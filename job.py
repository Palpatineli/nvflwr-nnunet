...
def main():
    ...
    env = {}
    if cast(bool, args.stream_metrics) or cast(bool, args.use_client_api):
    ...
    job = FlowerPyTorchJob(
        name=cast(str, args.job_name),
        flower_content=cast(str, args.content_dir),
        stream_metrics=cast(bool, args.stream_metrics),
